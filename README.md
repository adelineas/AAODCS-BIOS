...
Why ? Currently set switches can be implemented directly in the next flight.
...
If you intend to use this project in a commercial or revenue-generating context,
